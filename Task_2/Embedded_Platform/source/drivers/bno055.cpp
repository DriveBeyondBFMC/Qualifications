...
BNO055_RETURN_FUNCTION_TYPE bno055_init(struct bno055_t *bno055)
	{
		...
		p_bno055 = bno055;
		p_bno055->dev_addr = BNO055_I2C_ADDR << 1;
...
s32 bno055_read_euler_h()
	...
	if (p_bno055 == BNO055_Zero_U8X) {
		...
		status = bno055_write_page_id(PAGE_ZERO);
		if (status == SUCCESS) {
			comres = p_bno055->BNO055_BUS_READ_FUNC (p_bno055->dev_addr, BNO055_EUL_HEADING_LSB_VALUEH__REG, a_data_u8r, 2);
			a_data_u8r[0] = BNO055_GET_BITSLICE (a_data_u8r[0], BNO055_EUL_HEADING_LSB_VALUEH);
			a_data_u8r[1] = BNO055_GET_BITSLICE (a_data_u8r[1], BNO055_EUL_HEADING_MSB_VALUEH);
			data = (BNO055_S16)((((BNO055_S16) ((signed char)a_data_u8r[1])) << BNO055_SHIFT_8_POSITION) | (a_data_u8r[0]));
		} 
        else
		    return ERROR1;
	}
